...
const AboutUs = () => {
    ...
    return (
        <div ref={pageRef} className='lg:px-8 px-6 lg:pt-40 pt-24' >
            ...
            {/* Section 1 */}
            <div>
                <h1 className='about-head font-work font-medium text-[64px] lg:text-[118px] -tracking-wider leading-none p-0 m-0'>ABOUT</h1>

                <div className='flex flex-col lg:flex-row lg:gap-4 h-fit'>

                    <div className='lg:w-[15%] flex flex-col justify-between'>
                        <div>
                            <h1 className='about-head font-work font-medium text-[64px] lg:text-[118px] -tracking-wider leading-none p-0 m-0'>US</h1>

                            <p className='about-text font-work font-medium text-[#737373] lg:text-[16px] leading-[20px] text-[18px] -tracking-[3%] text-justify mt-2'>
                    ...
                    <div className='lg:w-[25%] flex flex-col-reverse lg:flex-col justify-between'>
                        ...
                        <div>
                            ...
                            <p className='about-text font-work font-medium text-[#737373] lg:text-[18px] text-[18px] leading-[20px] lg:leading-[27.9px] -tracking-[6%] text-justify'>
                                Every decision intentional, every space thoughtfully orchestrated, every home a reflection of its people.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className='bg-[#F9F7F3] lg:my-12 rounded-[32px] py-8'>
                <div className='lg:flex justify-between items-center'>
                    ...
                    <div>
                        <p className='about-text font-work text-[#737373] font-medium text-[16px] mt-4 lg:mt-0 lg:text-[16px] leading-[20.9px]'>
                            We shape interiors with intention, <br /> orchestrate spaces with care, <br /> and create homes that feel effortlessly <br /> lived-in.
                        </p>
                    </div>
                </div>
                ...
                <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 w-full mt-6'>
                    {experiences.map((experience, index) => (
                        <div key={index}>
                            <img className='exp-img w-full lg:h-[400px]' src={experience} alt="" />
                        </div>
                    ))}
                </div>
            </div>
                ...
                <div className='lg:w-[50%]'>
                    ...
                    <div className=' mt-2'>
                        <p className='about-text font-dm lg:text-[18px] lg:w-[80%]'>
                            Interiors designed to respond to the way you live. From concept to completion,
                            Truedo blends function, artistry, and precision to craft spaces that feel
                            effortless, personal, and timeless.
                        </p>
                    </div>

                    <div className='mt-6 lg:mt-12'>
                        <img className='promise-img w-full lg:h-[400px] object-cover rounded-[21px]' src={service} alt="" />
                    </div>
                </div>
