...
const AboutUs = () => {
  ...
  return (
    ...
    <div ref={pageRef} className="lg:px-8 px-6 lg:pt-40 pt-28">
      ...
      {/* Section 2 */}
      <div className="hidden bg-[#F9F7F3] lg:my-12 rounded-[32px] py-8">
      ...
      {/* Section 3 */}
      <div className="w-full flex lg:mt-16 flex-col lg:flex-row lg:gap-16">
     ...
     <div className="lg:px-8 w px-6 pt-16 lg:pt-32 pb-20 lg:pb-32 font-dm flex flex-col items-center justify-center">
