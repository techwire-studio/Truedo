...
const Contact = () => {
  return (
    <div className='lg:py-32 font-dm flex flex-col items-center justify-center'>
            ...
            <div className='absolute font-bold mt-28 bg-[#CD8A38] shadow-[0px_4.42px_9.02px_10.1px_rgba(255,176,4,0.2)] w-fit rounded-[60.74px] text-[#f5f5f5] font-dm lg:text-[20px] px-12 py-4 -rotate-6 hover:rotate-0 transition duration-300'>
                    Request a Call Back
            </div>
    </div>
  )
