...
const Contact = () => {
  return (
    <div className='lg:px-8 px-6 py-32 lg:py-32 font-dm flex flex-col items-center justify-center'>
            <div className='text-[#202B1A] font-semibold  text-[16px] lg:text-[28px]  font-dm rounded-[60.74px] border-dashed border-[#202B1A] border-[2.22px] px-8 lg:px-16 pt-4 lg:pt-4 pb-4 lg:pb-6'>
